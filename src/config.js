...
export const CONFIG = {
    ...
    ZOOM: 2,                // 👈 NEW: Global Zoom Level (2x)
    // --- World Dimensions ---
    ...
    HERO_ENERGY: 100,            // 🆕 Max Energy
    ENERGY_DRAIN_RATE: 0.5,      // 🆕 Drains 0.5 points per second (approx 3.3 mins from 100 to 0)
    ...
    // --- Visuals ---
    FONT_STYLE: '6px "Press Start 2P"', // 👈 Reduced so it looks crisp at 2x
